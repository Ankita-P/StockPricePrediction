...
graph_util.plot_graph_original_predicted(dataset[x.shape[0]:], "Apple's Stock Price Prediction Model - [Linear Regression Model]",
...
graph_util.plot_graph_original_predicted(dataset[x.shape[0]:], "Apple's Stock Price Prediction Model - [Knn Model]",
